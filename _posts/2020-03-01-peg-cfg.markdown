...
Finally, Medeiros et al[^medeiros2014on] any LL(1) grammar describes the same
language irrespective of whether it is interpreted as PEG or a CFG. However,
the languages differ beyond LL(1).
