...
backtracking can make parsing easy. For example, it is the technique used in META II by Schorre[^schorre1964meta] in 1965. 
Further, Aho et al.[^aho1972] showed that recognition using TDPL/GTPL which are equivalent
