...
The runnable Python source for this notebook is available [here](https://github.com/rahulgopinath/rahulgopinath.github.io/blob/master/notebooks/2019-12-04-hdd.py).


The installable python wheel `hdd` is available [here](/py/hdd-0.0.1-py2.py3-none-any.whl).
