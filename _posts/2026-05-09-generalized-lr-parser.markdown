...
<li><a href="https://rahul.gopinath.org/py/lrparser-0.0.1-py2.py3-none-any.whl">lrparser-0.0.1-py2.py3-none-any.whl</a> from "<a href="/post/2024/07/01/lr-parsing/">LR Parser</a>".</li>
</ol>
...
The runnable Python source for this notebook is available [here](https://github.com/rahulgopinath/rahulgopinath.github.io/blob/master/notebooks/2026-05-09-generalized-lr-parser.py).
