...
# Previously, we discussed how Delta-debug (_ddmin_) worked. However, pure
# _ddmin_ is limited when it comes to structured inputs.
...
#
# The solution here is to go for a variant called `Hierarchical Delta Debugging`[^misherghi2006hdd].
