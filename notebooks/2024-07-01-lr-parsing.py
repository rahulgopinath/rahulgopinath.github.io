...
# LALR1 DFA
# We do not have to commit to the entire LR(1). We can also manage with
# the states generated by SLR(1), but use the lookahead on a per rule basis.
